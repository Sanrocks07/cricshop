...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51PlWSAAYGtTcjxa4seA8zgKX4GBdpxC3eks80k04JUEx7LLY1OfHzWmQysHPPvnJQbywhbMFeiXuFaz4rqj1OhqQ00w5rGHBfu').then(stripe => {
      this.stripe = stripe;
  ...
  async submitOrder() {
    ...
    try {
      ...
      const paymentResult = await this.
